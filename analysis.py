...
def process_activity_data(details_json):
    ...
    km_stats = df.groupby('km_interval').agg({
...
def plot_activity_stats(km_stats):
    ...
    # Plot heart rate
    line1 = ax1.plot(km_stats['km_interval'], km_stats['directHeartRate'], 
    ...
    # Plot pace
    line2 = ax2.plot(km_stats['km_interval'], km_stats['pace'], 
                     color='blue', label='Pace')
...
def analyze_activity(details_json):
